<template>
  <div id="app">
    ...
    <main>
      <!-- 左侧导航 -->
      <div class="main-left">
        <el-menu default-zctive="/activePublic" class="el-menu-vertical-demo" :router="true">
          <el-menu-item index="/activePublic" :class="{'usActive': active}">活动发布</el-menu-item>
          <el-menu-item index="/activePublic" :class="{'usActive': !active}">活动管理</el-menu-item>
        </el-menu>
      </div>
