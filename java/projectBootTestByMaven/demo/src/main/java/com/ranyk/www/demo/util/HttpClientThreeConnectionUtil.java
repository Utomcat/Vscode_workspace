...
/**
 * @CLASS_NAME: HttpClientThreeConnectionUtil.java
 * @description: HttpClient3 网络请求工具类
 * 
 * @author: ranYk
 * @version: V1.0
 */
@Slf4j
public class HttpClientThreeConnectionUtil {


    private HttpClientThreeConnectionUtil(){
    ...
    public static String doPost(String url, Map<String, Object> paramMap) {
        ...
        try {
            ...
            // 判断是否成功
            if (statusCode != HttpStatus.SC_OK) {
                log.error("Method faild: " + postMethod.getStatusLine());
            }
            // 获取远程返回的数据
